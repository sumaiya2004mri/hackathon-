  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        ...
        <p className="mx-auto mt-2 max-w-xl text-center text-slate-500">
          Save your data to your account and track it over time.
        </p>
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          <button
            onClick={() => onNavigate("pregnancy")}
            className="card group p-6 text-left transition-all hover:shadow-md hover:-translate-y-0.5"
          >
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-rose-50 text-rose-500 transition-colors group-hover:bg-rose-500 group-hover:text-white">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              Week-by-week fetal size, milestones, and a symptom checker
              that routes danger signs straight to emergency guidance.
            </p>
          </button>
          <button
            onClick={() => onNavigate("female-health")}
            className="card group p-6 text-left transition-all hover:shadow-md hover:-translate-y-0.5"
          >
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-rose-50 text-rose-500 transition-colors group-hover:bg-rose-500 group-hover:text-white">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              Log periods, see your personal average, and get a gentle
              flag if a cycle looks irregular — plus CSV export.
            </p>
          </button>
        </div>
      </section>
